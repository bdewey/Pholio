...
@class IPFlickrSearchCell;
@interface IPFlickrSearchSource : NSObject<BDAssetsSource> { }

//
//  Search cell that contains all of our search parameters (api, arguments, title,
//  result key path).
//
